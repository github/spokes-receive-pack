...
// Command returns a pipeline `Stage` based on any external command.
// Its stdin and stdout are handled as usual, and its stderr is
// collected and included in any `*exec.ExitError` that the command
// might emit.
